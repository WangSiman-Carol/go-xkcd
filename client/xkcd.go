...
const (
	...
	// LatestComic is latest comic number according to the xkcd API
	LatestComic ComicNumber = 0
)

/*
* XKCDClient is the client for XKCD. Client sends requests to xkcd API
 */
...
// SaveToDist() downloads and saves the comic locally
